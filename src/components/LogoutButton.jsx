...
const LogoutButton = ({ className }) => {
    ...
    return (<AlertDialog>
            ...
            <AlertDialogContent className="glass-dark border-white/10 text-white rounded-[2rem]">
                <AlertDialogHeader>
                    <AlertDialogTitle className="text-2xl font-black">Confirm Logout</AlertDialogTitle>
                ...
                <AlertDialogFooter className="mt-6 gap-3">
                    ...
                    <AlertDialogAction onClick={handleLogout} className="bg-red-500 hover:bg-red-600 text-white rounded-xl py-6 px-8 border-none font-bold shadow-lg shadow-red-500/20">
                        Yes, Log Out
                    </AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
